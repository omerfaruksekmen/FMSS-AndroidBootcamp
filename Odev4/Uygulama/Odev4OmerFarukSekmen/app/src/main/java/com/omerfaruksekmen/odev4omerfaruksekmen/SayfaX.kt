...
fun SayfaX(navController: NavController){
    ...
    Column(modifier = Modifier.fillMaxSize(),
        ...
        Text(text = "SAYFA X", fontSize = 25.sp, fontWeight = FontWeight.Bold, color = Color.Red)
        Button(onClick = {
            ...
            Toast.makeText(context, "Sayfa X Back Stack'ten silindi !", Toast.LENGTH_SHORT).show()
